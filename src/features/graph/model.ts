 ...
 * translucent node lets everything under it through, and the relations are drawn under the nodes:
 * the operator saw **the ends of the lines inside the dots**, and the graph drew a hollow-looking
 * dot where the map drew a solid one. The dim is a change of **appearance**, not a hole.
 *
 ...
 * canvases then disagree, and every line end shows through again.
 */
