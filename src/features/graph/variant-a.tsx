...
export const VariantA = memo(function VariantA({ entityCount }: { entityCount: number }) {
  ...
  return (
    <div className="relative size-full overflow-hidden rounded-lg border border-border bg-background">
      ...
      <div
        ref={filters}
        className="absolute left-3 top-3 z-20 flex flex-wrap items-center gap-1.5 rounded-lg border border-border bg-background/90 p-2 backdrop-blur"
      />
      <div className="pointer-events-none absolute bottom-3 left-3 z-20 flex flex-col gap-1 rounded-lg border border-border bg-background/90 p-2 backdrop-blur">
