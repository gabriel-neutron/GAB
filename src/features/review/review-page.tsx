...
import { VariantInPlace } from './variant-inplace';
...
export function ReviewPage({ variant, subjectId, onSelect }: ReviewPageProps) {
  ...
  if (variant === 'inspector') return <VariantInspector {...props} />;
  if (variant === 'record') return <VariantInPlace {...props} />;
  return <VariantLedger {...props} />;
}
