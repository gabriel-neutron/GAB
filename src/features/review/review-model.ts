...
export interface Change {
  ...
  /** `extractor v4`, or null. An operator edit names an agent that never ran — see `authorLabel`. */
...
/** How old a change is, in words. Three layouts print this, so it is written once. */
