/**
 * **PROTOTYPE — throwaway.** The floating bar. It flips the surface and it reaches the density
 * probe. It is deliberately plain, so that nobody reads it as part of the design, and it is
...
export function PrototypeSwitcher({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-50 flex justify-center">
      <div className="pointer-events-auto flex items-center gap-2 rounded-4xl border-2 border-foreground bg-background px-2 py-1.5 shadow-lg">
        <Button
          size="sm"
