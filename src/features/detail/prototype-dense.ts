...
export const denseDocuments: readonly DocumentRow[] = [
  doc(
    IHS,
    'report',
    'Vessel particulars extract — MV Aegean Trader',
    'particulars/9482137',
    '2026-06-04',
    'A2',
    'machine',
  ...
  doc(
    REG,
    'url',
    'Panama Maritime Authority — registry entry 55129014',
    'registry/pa-55129014',
    '2026-05-28',
    'A1',
    'human',
  ),
  doc(
    CLASS,
    'report',
    'ClassNK — survey status report, AEG-2026-114',
    'class/aeg-2026-114',
    '2026-05-12',
    'B2',
    'machine',
  ...
  doc(
    EQUASIS,
    'url',
    'Equasis — ownership and management record',
    'equasis/9482137',
    '2026-06-01',
    'B3',
    'machine',
  ...
  doc(
    AIS,
    'api',
    'AIS track export, January to July 2026',
    'ais/9482137-h1-2026',
    '2026-07-02',
    'C3',
    'machine',
  ...
  doc(
    PORT,
    'file',
    'Port of Rotterdam — berth log, second quarter 2026',
    'ports/rtm-q2-2026',
    '2026-07-14',
    'B2',
    'arbitrated',
  ...
  doc(
    PANDI,
    'file',
    'Protection and indemnity club — certificate of entry',
    'pandi/cert-9482137',
    '2026-02-20',
    'A2',
    'human',
  ...
  doc(
    FIXTURE,
    'file',
    'Fixture note — voyage charter, Tubarão to Rotterdam',
    'fixtures/tub-rtm-0426',
    '2026-04-26',
    'C4',
    'arbitrated',
  ),
  doc(
    SDN,
    'url',
    'Sanctions list entry — designated vessel record',
    'sanctions/list-entry-4471',
    '2026-06-30',
    'A1',
    'human',
  ),
  ...
  doc(
    PRESS,
    'url',
    'Trade press article on the Aegean fleet',
    'press/aegean-fleet-note',
    '2026-07-09',
    null,
    null,
  ),
  doc(
    ANNUAL,
    'report',
    'Aegean Bulk Holdings SA — annual report 2025',
    'filings/abh-2025',
    '2026-03-31',
    'B2',
    'machine',
  ...
  doc(
    GISIS,
    'api',
    'Casualty and incident record, 2018 to 2026',
    'casualty/9482137',
    '2026-06-11',
    'A2',
    'machine',
...
const denseAttrs: Readonly<Record<string, Attribute>> = {
  ...
  inspection_note: at(
    'Hold 4 coating worn on the port side, seen in the terminal photograph.',
    MANUAL,
  ),
