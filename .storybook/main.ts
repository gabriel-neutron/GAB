 ...
 * `@storybook/addon-vitest` makes each story a Vitest test, and runs it in Chromium. **One
 * runner holds**, and a second one is refused.
 *
...
const config: StorybookConfig = {
  ...
  // that no boundaries element declares fails `pnpm check` on purpose. A story
  ...
  //
  // Write no story for `map-page.tsx`, and no story for `graph-page.tsx`. MapLibre and Sigma
